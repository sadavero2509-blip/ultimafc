        ...
        self.banners = [
            {
                ...
                "hints": [
                    {"ovr": 95, "nat": "BRA", "pos": "LW", "type": "EVENTO", "name": "Vini Jr."},
                    {"ovr": 94, "nat": "ARG", "pos": "RW", "type": "EVENTO", "name": "Lionel Messi"},
                    {"ovr": 94, "nat": "FRA", "pos": "LW", "type": "EVENTO", "name": "Kylian Mbappé"}
                ],
            ...
            },
            {
                ...
                "hints": [
                    {"ovr": 99, "nat": "BRA", "pos": "ST", "type": "LEYENDA", "name": "Pelé"},
                    {"ovr": 98, "nat": "ARG", "pos": "CAM", "type": "LEYENDA", "name": "Diego Maradona"}
                ],
