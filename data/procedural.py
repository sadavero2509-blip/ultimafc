...
PATTERNS = {
    "EN": {"first": ["J.", "T.", "H.", "B.", "C.", "M."], "last": ["Smith", "Jones", "Brown", "Taylor", "White", "Cole", "Kane", "Grealish", "Foden"]},
    "ES": {"first": ["A.", "P.", "J.", "D.", "F.", "L."], "last": ["García", "Pérez", "López", "Gómez", "Torres", "Martínez", "Ramos", "Isco"]},
    "IT": {"first": ["M.", "L.", "F.", "G.", "A.", "C."], "last": ["Rossi", "Russo", "Ferrari", "Esposito", "Bianchi", "Ricci", "Chiesa", "Barella"]},
    "DE": {"first": ["T.", "L.", "M.", "H.", "F.", "J."], "last": ["Müller", "Schmidt", "Schneider", "Fischer", "Weber", "Meyer", "Kimmich", "Sané"]},
    "FR": {"first": ["H.", "K.", "N.", "P.", "L.", "E."], "last": ["Martin", "Bernard", "Thomas", "Petit", "Robert", "Durand", "Mbappe", "Dembele"]},
    "PT": {"first": ["J.", "R.", "B.", "D.", "C.", "N."], "last": ["Silva", "Santos", "Ferreira", "Pereira", "Oliveira", "Costa", "Felix", "Dias"]},
    "BR": {"first": ["R.", "G.", "L.", "V.", "M.", "E."], "last": ["da Silva", "dos Santos", "Pereira", "Alves", "Ribeiro", "Gomes", "Gabriel", "Vini"]},
    ...
    "UY": {"first": ["F.", "D.", "L.", "R.", "M.", "N."], "last": ["Valverde", "Núñez", "Suárez", "Araújo", "Giménez", "Bentancur", "De la Cruz", "Olivera"]},
    "NL": {"first": ["V.", "C.", "M.", "N.", "X.", "J."], "last": ["van Dijk", "Gakpo", "Simons", "Aké", "Dumfries", "Depay", "de Ligt", "Reijnders"]},
    "BE": {"first": ["K.", "J.", "L.", "R.", "A.", "Y."], "last": ["De Bruyne", "Doku", "Lukaku", "Trossard", "Onana", "Tielemans", "Casteels", "Faes"]},
    "HR": {"first": ["L.", "J.", "M.", "A.", "B.", "D."], "last": ["Modric", "Gvardiol", "Kovacic", "Kramaric", "Brozovic", "Livakovic", "Sutalo", "Perisic"]},
    "MA": {"first": ["A.", "Y.", "H.", "B.", "S.", "N."], "last": ["Hakimi", "Bounou", "Ziyech", "En-Nesyri", "Amrabat", "Ounahi", "Mazraoui", "Abde"]},
