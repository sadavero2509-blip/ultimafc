...
FLASHBACK_PLAYERS = [
    ...
    {
        "name": "Cristiano Ronaldo", "pos": "LM", "ovr": 91, "nat": "POR", "team": "POR",
        "card_type": "FLASHBACK", "event": "CRÓNICAS DEL TIEMPO",
